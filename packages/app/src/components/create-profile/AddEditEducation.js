...
import { addEduction } from "../../actions/profileActions";
...
class AddEditEducation extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.addEduction(eductionData, this.props.history);
  }
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead">
                Add any school/university/bootcamp that you have attended
              </p>
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextAreaGroup
                  ...
                  info="Tell us about the study modules"
                />
                <input
                  type="submit"
                  value="Submit"
