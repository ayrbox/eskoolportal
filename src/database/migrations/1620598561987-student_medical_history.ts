...
export class studentMedicalHistory1620598561987 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "medical_history" ADD CONSTRAINT "FK_cea2450774037c773a730f3700a" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "medical_history" DROP CONSTRAINT "FK_cea2450774037c773a730f3700a"`
    );
